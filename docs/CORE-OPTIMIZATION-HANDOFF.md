...
- **2026-09-26 复验问题修复（未发布）**：RR-25～29、31、32 已修复，RR-04/05/07/10/11/12/15/17/19/22/24 复核补修完成；**RR-20260926-30 未修复**（本地 lease fence 跳过，需维护者拍板契约）。RR-28 复核中发现并堵上“持久拒绝后解冻会把被拒绝的内存修改写出”（含修复前 Durability 1 首轮拒绝的同类泄漏）。已随 **v1.17.0**（2026-09-26）发布；RR-30 作为已知风险写入发布说明。
...
| [RR-20260926-33](bug/RR-20260926-33.md) | WAL fsync 失败后仍信任后续 fsync，checkpoint 越过未落盘数据 | 未修复 |
| [RR-20260926-34](bug/RR-20260926-34.md) | 投影在 Mongo 事务内撞键后继续读，真实 Mongo 下投影卡死 | 未修复 |
| [RR-20260926-35](bug/RR-20260926-35.md) | handler 内 CreateInScope 不在提交边界内 | 未修复 |
| [RR-20260926-36](bug/RR-20260926-36.md) | 冷登录等待投影无超时 | 未修复 |
| [RR-20260926-37](bug/RR-20260926-37.md) | Remote strict 确认超时后 Sync 冻结、AfterCommit 丢失 | 未修复 |
| [RR-20260926-38](bug/RR-20260926-38.md) | finalizer 与投影器并发发布同一 Remote 事务 | 未修复 |
| [RR-20260926-39](bug/RR-20260926-39.md) | 被拒绝隔离的 Remote 实体无重载入口 | 未修复 |
| [RR-20260926-40](bug/RR-20260926-40.md) | demo 重连时移出新连接玩家 | 未修复 |
| [RR-20260926-41](bug/RR-20260926-41.md) | 零填充尾部拒绝打开 | 未修复 |
| [RR-20260926-42](bug/RR-20260926-42.md) | dataengine.shutdown_timeout 不生效 | 未修复 |
| [RR-20260926-43](bug/RR-20260926-43.md) | versionedLock 续期重启窗口 | 未修复 |
| [RR-20260926-44](bug/RR-20260926-44.md) | Prepare 失败 Abort 多占快池续行 | 未修复 |
| [RR-20260926-45](bug/RR-20260926-45.md) | Remote 实体允许 sid 作用域 DAO | 未修复 |
| [RR-20260926-46](bug/RR-20260926-46.md) | 已提交但释放失败无已提交哨兵 | 未修复 |
| [RR-20260926-47](bug/RR-20260926-47.md) | 准入判定依赖自定义 Getter 契约 | 未修复 |
