...
2. 发布 Go 模块 `github.com/tjbdwanghaibo/roost-core/skill`（核心 API 固定在 `/skill`；wire schema 仍独立使用 `roost.skill/v2`）。
...
=> github.com/tjbdwanghaibo/roost-core/skillcompose
```
