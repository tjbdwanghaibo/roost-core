...
- **结论（2026-09-23）**：维护者选 (a)。M-18 删掉 datagram lane、分片头、`AdmitBatch / OutboundFrame / AtomicBatchTransport / AdmissionError`；UDP / KCP / QUIC 的裸 `SendDatagram` 保留给 lockstep。见 [M-18](../bugfix/M-18-async-transport-reliable-only.md)。
