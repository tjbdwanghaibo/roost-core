...
| RR-20260909-02 | P2 | kit | Session 冲突清理误删重新取得的 claim（ABA） | 已复现，未修复 → [第二轮复核](REVIEW-2026-09-09-02.md) |
| RR-20260909-03 | P2 | core | Assembly 停机未完成即遗失 Runtime，重试虚报成功 | 已复现，未修复 → [第三轮](REVIEW-2026-09-09-03.md) |
| RR-20260909-04 | P2 | codegen | 同包多个 Entity 生成重名注册符号，消费者无法编译 | 已复现，未修复 → [第三轮](REVIEW-2026-09-09-03.md) |
