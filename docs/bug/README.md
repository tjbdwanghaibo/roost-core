...
| 编号 | 等级 | 问题 | 状态 |
| --- | --- | --- | --- |
| RR-20260918-05 | P1 | 邮件去重账本固定 31 天，合法的更长 `send_ttl` 让旧邮件再次发奖 | 未修复 |
| RR-20260918-06 | P2 | 会话关闭没有生命周期事件，scene/presence 无后续流量时保留离线成员 | 未修复 |
...
| RR-20260918-09 | P1 | 怪物运行期 ID 进程本地发号，多 game 实例碰撞 | 未修复 |
