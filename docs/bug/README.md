...
| 编号 | 优先级 | 仓库 | 问题 | 状态 |
| --- | --- | --- | --- | --- |
| RR-20260914-04 | P2 | core | lockstep 已入帧输入迟到重传再次入帧 | 未修复 → [第三轮](REVIEW-2026-09-14-03.md) |
| RR-20260914-05 | P2 | core | lockstep 每 tick 补一帧无法追上帧头 | 未修复 → [第三轮](REVIEW-2026-09-14-03.md) |
| RR-20260914-06 | P3 | core | lockstep 座位 -1 与旁观者标记碰撞 | 未修复 → [第三轮](REVIEW-2026-09-14-03.md) |
| RR-20260914-07 | P3 | core | lockstep 超协议座位数配置生成不可解码帧 | 未修复 → [第三轮](REVIEW-2026-09-14-03.md) |
