...
| 编号 | 优先级 | 仓库 | 问题 | 状态 |
| --- | --- | --- | --- | --- |
| RR-20260910-02 | P2 | kit | 已领取邮件淘汰后重投生成新发奖 token | 未修复 → [第二轮](REVIEW-2026-09-10-02.md) |
| RR-20260910-01 | P3 | core | 极短 IdleTTL 推导出零扫描周期 | 未修复 → [2026-09-10](REVIEW-2026-09-10.md) |
