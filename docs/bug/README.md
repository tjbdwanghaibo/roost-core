...
| 编号 | 优先级 | 仓库 | 问题 | 状态 |
| --- | --- | --- | --- | --- |
| RR-20260913-13 | P2 | core | LeaveShared 回复丢失后普通写重试卡在非法状态迁移 | 修复待验收（U-0189 同步到达） → [第十轮](REVIEW-2026-09-13-10.md) |
| RR-20260913-12 | P2 | core | EnterShared 执行后丢回复恢复独占写准入 | 已修复(U-0189,未发版)→ [bugfix](../bugfix/RR-20260913-12.md) · [第九轮](REVIEW-2026-09-13-09.md) |
