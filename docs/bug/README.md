...
| 编号 | 优先级 | 仓库 | 问题 | 状态 |
| --- | --- | --- | --- | --- |
| RR-20260914-03 | P2 | kit | Activity 派发仅扫描本轮新完成，后续重试与其他完成路径被遗漏 | 未修复 → [第二轮](REVIEW-2026-09-14-02.md) |
| RR-20260914-02 | P2 | kit | OpenActivity 与 sweep 交错丢失活动窗口索引 | 未修复 → [第二轮](REVIEW-2026-09-14-02.md) |
