...
| 编号 | 等级 | 问题 | 状态 |
| --- | --- | --- | --- |
| RR-20260920-09 | P1 | 租约失而复得后仍用失效期间没重新加载过的常驻 Player 实体；表里也无法分辨中间有没有别人写过 | 已修复（U-0268，未发版）→ [bugfix](../bugfix/RR-20260920-09.md) |
| RR-20260920-10 | P2 | 后台消费者为离线玩家取得的租约永不归还，该玩家此后只能从那一个进程登录 | 已修复（U-0269，未发版）→ [bugfix](../bugfix/RR-20260920-10.md) |
