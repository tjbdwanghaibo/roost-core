...
| 编号 | 等级 | 问题 | 状态 |
| --- | --- | --- | --- |
| RR-20260917-01 | P2 | 合法 Queue 键碰撞，跨队列读取与成组 | 未修复 |
| RR-20260917-02 | P2 | ScoreWindow 距离及窗口增长溢出 | 未修复 |
| RR-20260917-03 | P3 | 内存 Store 输入/输出切片共享污染状态 | 未修复；仅内存范围确认 |
...
| 编号 | 优先级 | 仓库 | 问题 | 状态 |
| --- | --- | --- | --- | --- |
| RR-20260916-07 | P2 | core/kit | 首个 manager 启动期间 Register 接纳的对象永久未启动 | 未修复 → [第五轮复现](REVIEW-2026-09-16-05.md) |
| RR-20260916-06 | P2 | core/kit | 最后一个 manager 启动期间 Stop 漏清理成功启动的对象 | 未修复 → [第五轮复现](REVIEW-2026-09-16-05.md) |
