...
[RR-20260926-47](RR-20260926-47.md)：P3 准入判定依赖自定义 Getter 契约（未修复）。

[RR-20260926-46](RR-20260926-46.md)：P3 已提交但释放失败无已提交哨兵（未修复）。

[RR-20260926-45](RR-20260926-45.md)：P3 Remote 实体允许 sid 作用域 DAO（未修复）。

[RR-20260926-44](RR-20260926-44.md)：P3 Prepare 失败 Abort 多占快池续行（未修复）。

[RR-20260926-43](RR-20260926-43.md)：P3 versionedLock 续期重启窗口（未修复）。

[RR-20260926-42](RR-20260926-42.md)：P3 dataengine.shutdown_timeout 不生效（未修复）。

[RR-20260926-41](RR-20260926-41.md)：P3 零填充尾部拒绝打开（未修复）。

[RR-20260926-40](RR-20260926-40.md)：P2 demo 重连时移出新连接玩家（未修复）。

[RR-20260926-39](RR-20260926-39.md)：P2 被拒绝隔离的 Remote 实体无重载入口（未修复）。

[RR-20260926-38](RR-20260926-38.md)：P2 finalizer 与投影器并发发布同一 Remote 事务（未修复）。

[RR-20260926-37](RR-20260926-37.md)：P2 Remote strict 确认超时后 Sync 冻结、AfterCommit 丢失（未修复）。

[RR-20260926-36](RR-20260926-36.md)：P2 冷登录等待投影无超时（未修复）。

[RR-20260926-35](RR-20260926-35.md)：P2 handler 内 CreateInScope 不在提交边界内（未修复）。

[RR-20260926-34](RR-20260926-34.md)：P2 投影在 Mongo 事务内撞键后继续读，真实 Mongo 下投影卡死（未修复）。

[RR-20260926-33](RR-20260926-33.md)：P2 WAL fsync 失败后仍信任后续 fsync，checkpoint 越过未落盘数据（未修复）。 v1.17.0 疑点核实 [REVIEW-2026-09-26-v1170-triage](../review/REVIEW-2026-09-26-v1170-triage.md)，复现 [REPRO-2026-09-26-04](REPRO-2026-09-26-04.md)。
...
[RR-20260926-30](RR-20260926-30.md)：P2 saga 原生步骤本地 lease fence 过期跳过后，后续投影 fatal、重启起不来（未修复，需维护者拍板）。
