...
| 编号 | 优先级 | 仓库 | 问题 | 状态 |
| --- | --- | --- | --- | --- |
| RR-20260914-13 | P2 | core | LOD 绝对 tick 采样使错相发送的组件持续保留旧值 | 未修复 → [第八轮](REVIEW-2026-09-14-08.md) |
| RR-20260914-11 | P2 | core | ForceFull 被旧发送 ACK 取消 | 未修复 → [第七轮](REVIEW-2026-09-14-07.md) |
| RR-20260914-12 | P3 | core | 单片重组绕过 MaxFrameBytes | 未修复 → [第七轮](REVIEW-2026-09-14-07.md) |
| RR-20260914-10 | P2 | core | 同 tick 投影覆盖使延迟 ACK 绑定错误基线，后续 delta 静默漏对象 | 未修复 → [第六轮](REVIEW-2026-09-14-06.md) |
