...
| 编号 | 优先级 | 仓库 | 问题 | 状态 |
| --- | --- | --- | --- | --- |
| RR-20260915-03 | P2 | core | entitysync 订阅快照与直接分发绕过持久化水位 | 未修复 → [第三轮](REVIEW-2026-09-15-03.md) |
| RR-20260915-02 | P2 | core | 重叠准备视图已交付后 Commit stale，后续 delta 仍静默分叉 | 未修复 → [第二轮](REVIEW-2026-09-15-02.md)，关联 RR-20260914-10 |
