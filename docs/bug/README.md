...
| 编号 | 等级 | 问题 | 状态 |
| --- | --- | --- | --- |
| RR-20260918-05 | P1 | 邮件去重账本固定 31 天，合法的更长 `send_ttl` 让旧邮件再次发奖 | 已修复（U-0241，未发版）→ [bugfix](../bugfix/RR-20260918-05.md) |
| RR-20260918-06 | P2 | 会话关闭没有生命周期事件，scene/presence 无后续流量时保留离线成员 | 已修复（U-0243，未发版）→ [bugfix](../bugfix/RR-20260918-06.md) |
| RR-20260918-07 | P2 | syncTopic 裸同包常量被静默生成成常量名字符串 | 已修复（U-0239，未发版）→ [bugfix](../bugfix/RR-20260918-07.md) |
| RR-20260918-08 | P2 | 单观察者 AOI block 数无预算，合法配置可登记 40,401 格 | 已修复（U-0240，未发版）→ [bugfix](../bugfix/RR-20260918-08.md) |
| RR-20260918-09 | P1 | 怪物运行期 ID 进程本地发号，多 game 实例碰撞 | 已修复（U-0242，未发版）→ [bugfix](../bugfix/RR-20260918-09.md) |
| RR-20260918-10 | P1 | 顶层 DAO map 替换/回滚后游离 nested 值仍可生成持久化 mutation | 已修复（U-0238，未发版）→ [bugfix](../bugfix/RR-20260918-10.md) |
