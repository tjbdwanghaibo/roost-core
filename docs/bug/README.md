...
| 编号 | 优先级 | 仓库 | 问题 | 状态 |
| --- | --- | --- | --- | --- |
| RR-20260909-05 | P2 | kit | Match Enqueue 请求重放未校验 Subject 归属 | 未修复 → [第四轮](REVIEW-2026-09-09-04.md) |
| RR-20260909-06 | P2 | codegen | 多 Entity 显式 -output 静默覆盖产物 | 未修复 → [第四轮](REVIEW-2026-09-09-04.md) |
