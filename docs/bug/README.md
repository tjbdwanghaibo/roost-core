...
| 编号 | 优先级 | 仓库 | 问题 | 状态 |
| --- | --- | --- | --- | --- |
| RR-20260913-09 | P2 | core | Transfer 回复丢失后恢复旧 owner 并允许写准入 | 已修复(U-0188,未发版)→ [bugfix](../bugfix/RR-20260913-09.md) · [09-13 第三轮](REVIEW-2026-09-13-03.md) |
...
| RR-20260913-05 | P2 | core | L2 内容冲突被吞掉，L1/L2 同版本分叉 | 已修复(U-0180,未发版)→ [bugfix](../bugfix/RR-20260913-05.md) · [第二轮](REVIEW-2026-09-13-02.md) |
| RR-20260913-06 | P2 | core | L2 回填绕过同版本冲突检查 | 已修复(U-0181,未发版)→ [bugfix](../bugfix/RR-20260913-06.md) · [09-13 第二轮](REVIEW-2026-09-13-02.md) |
...
| RR-20260913-08 | P2 | core | 快照 ExpiresAt 未参与缓存读取准入 | 部分修复(U-0175)：Cached 通过，权威出口仍返回过期值→ [bugfix](../bugfix/RR-20260913-08.md) · [09-13 第二轮](REVIEW-2026-09-13-02.md) · [第四轮残余复现](REVIEW-2026-09-13-04.md) |
| RR-20260913-01 | P2 | core | Remote 删除无版本屏障，旧删除清新值/旧值复活 | 已修复(U-0187,未发版)→ [bugfix](../bugfix/RR-20260913-01.md) · [09-13](REVIEW-2026-09-13.md) |
| RR-20260913-02 | P2 | core | 旧兴趣释放取消重新订阅 | 已修复(U-0184,未发版)→ [bugfix](../bugfix/RR-20260913-02.md) · [09-13](REVIEW-2026-09-13.md) |
...
| RR-20260912-01 | P2 | core | nestwal Shutdown 等待后台重放锁时忽略截止时间 | 已修复(U-0186,未发版)→ [bugfix](../bugfix/RR-20260912-01.md) · [09-12](REVIEW-2026-09-12.md) |
| RR-20260912-02 | P2 | core | WAL.Sync 成功返回时已准入 ticket 仍未写入 | 已修复(U-0185,未发版)→ [bugfix](../bugfix/RR-20260912-02.md) · [09-12](REVIEW-2026-09-12.md) |
| RR-20260911-06 | P2 | core | 异步 AfterCommit panic 遗漏回复/释放；饱和回退可崩溃 | 已修复(U-0183,未发版)→ [bugfix](../bugfix/RR-20260911-06.md) · [第四轮](REVIEW-2026-09-11-04.md) |
| RR-20260911-05 | P3 | kit | 拒绝投递仍修改 MemoryStore 邮箱，计数与条目不一致 | 已修复(U-0182,未发版)→ [bugfix](../bugfix/RR-20260911-05.md) · [第三轮](REVIEW-2026-09-11-03.md) |
