...
| RR-20260918-07 | P2 | syncTopic 裸同包常量被静默生成成常量名字符串 | 未修复 |
| RR-20260918-08 | P2 | 单观察者 AOI block 数无预算，合法配置可登记 40,401 格 | 未修复 |
| RR-20260918-09 | P1 | 怪物运行期 ID 进程本地发号，多 game 实例碰撞 | 未修复 |
| RR-20260918-10 | P1 | 顶层 DAO map 替换/回滚后游离 nested 值仍可生成持久化 mutation | 未修复 |
