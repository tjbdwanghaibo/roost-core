...
| 编号 | 优先级 | 仓库 | 问题 | 状态 |
| --- | --- | --- | --- | --- |
| RR-20260910-03 | P2 | core | 完成事务 tracker 淘汰导致等待者 panic | 已修复(U-0168,未发版)→ [bugfix](../bugfix/RR-20260910-03.md) · [第三轮](REVIEW-2026-09-10-03.md) |
| RR-20260910-05 | P2 | codegen | category 外包常量遗漏生成 import（M-05） | 已修复(U-0166,未发版)→ [bugfix](../bugfix/RR-20260910-05.md) · [第三轮](REVIEW-2026-09-10-03.md) |
| RR-20260910-06 | P2 | codegen | 聚合注册固定 entity 导入与业务别名冲突（M-05） | 已修复(U-0167,未发版)→ [bugfix](../bugfix/RR-20260910-06.md) · [第三轮](REVIEW-2026-09-10-03.md) |
| RR-20260910-04 | P3 | core | Checkpoint 恢复改变完成历史淘汰顺序 | 已修复(U-0169,未发版)→ [bugfix](../bugfix/RR-20260910-04.md) · [第三轮](REVIEW-2026-09-10-03.md) |
