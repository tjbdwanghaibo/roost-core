...
最新实施入口：[Mirror 实施交接](PLAN-REMOTE-POLICY-MIRROR.md)（2026-09-13）：六步提交、当前 bug 依赖、订阅代际和验收清单。下方 09-12 的源码与测试记录保留为历史证据；方案尚未实施。

后续证据：[09-13 接收链审查](REVIEW-2026-09-13.md)已将删除顺序风险推进为真实 Replicator/接收器的确定性复现，并新增兴趣代际、payload 身份及加载等待名额问题。以下方案仍未实施。
