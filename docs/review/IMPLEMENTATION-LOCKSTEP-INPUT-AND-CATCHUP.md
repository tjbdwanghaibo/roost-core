...
第六轮补充（Core 2c5469e）：U-0198 区分已收到与已应用，出站失败保留阶段和尾帧，Simulate 失败 terminal；原四叶子通过。U-0199 将窗口校验前置，索引先在 FrameID 域取模再转 int；独立拒绝副作用测试修前失败、修后通过。[漏审复盘](POSTMORTEM-LOCKSTEP-U0199.md) · [运行证据](REVIEW-2026-09-14-06.md)。
