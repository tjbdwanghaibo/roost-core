...
| 序 | 项 | 轨 | 改代码 | 发版 | 估时 |
| --- | --- | --- | --- | --- | --- |
| 1 | B-18 entitysync（U-0104） | U / C2 | 否 | 否 | 半个会话 |
| 2 | B-19 redis（U-0105，可能拆 U-0106） | U / C2 | 否 | 否 | 1 个会话 |
| 3 | B-14 摘要丢错（U-0107） | U / C5 | 是（core） | 不单发；随 P3b core v1.15.0 | 1 个会话 |
| 4 | 安静基准归档 | 测量 | 否（补脚本） | 否 | 机器空闲 1～1.5 小时，人工 20 分钟 |
| 5 | P3b Mod 瘦身 | M | 是（core + kit） | core v1.15.0 → kit v1.14.0 → codegen 清单 | 2～3 天，分三小批 |
