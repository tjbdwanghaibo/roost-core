...
> M-01 entity kind 注册表无锁化、M-02 category 离开 EntityID、M-03 声明式锁序(重构,不占 U 编号)见 [bugfix/](../bugfix/README.md);M-01 那篇记录了 category 重设计的四步方案,目前前四步已实施(M-04 删除旧符号,破坏性,core 与 codegen 同版本),生成器接管注册与封表尚未做。
