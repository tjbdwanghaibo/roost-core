...
> 接手导读（方法、坑、剩余工作、一天的节奏）见 [HANDOFF_2026-09-07.md](HANDOFF_2026-09-07.md)。
> Core/Kit 实现下沉与本账本的联合执行入口见 [统一实施方案](../CORE_KIT_REFACTOR_AND_AUDIT_PLAN.zh-CN.md)。U 单元协议保持不变；重构使用独立 M 批次，本文仍是缺陷状态唯一来源。
> M-00a 消费方对齐及五仓基线见 [续跑记录](M-00a_SOURCE_HEAD_ALIGNMENT.md)；这是迁移前置结构工作，不计为新增 U 单元或覆盖矩阵审计。
> M-01 entity kind 注册表无锁化、M-02 category 离开 EntityID、M-03 声明式锁序(重构,不占 U 编号)见 [bugfix/](../bugfix/README.md);M-01 那篇记录了 category 重设计的四步方案,目前前四步已实施(M-04 删除旧符号,破坏性,core 与 codegen 同版本),M-05 让 `category=` 进标记并在生成的聚合注册末尾校验注册表;封表与身份层拆分尚未做。
...
| core | `admin` | 09-02 | 09-06 U-0070（回退 3 条） / 09-09 U-0147 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 |
| core | `ai` | 09-02 | 09-02 / 09-09 U-0148 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 |
...
| core | `cache` | 09-02 | 09-06 U-0076（回退 2 条） / 09-07 U-0102（回退 8 条） / 09-09 U-0138（回退 8 条） / 09-09 U-0155（修复） | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-06 U-0076 / 09-13 U-0181（修复） 
...
| core | `failurelog` | 09-02 | 09-02 / 09-09 U-0147 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 |
...
| core | `goroutine` | 09-02 | 09-02 / 09-09 U-0147 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 |
| core | `health` | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 |
| core | `hotcode` | 09-02 | 09-06 U-0071（回退 2 条） / 09-09 U-0149 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 |
| core | `httpclient` | 09-02 | 09-02 / 09-09 U-0149 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 |
...
| core | `lockstep` | 09-02 | 09-02 / 09-09 U-0137（回退 7 条，1 不可达） | 09-02 | 09-02 / 09-14 U-0196（修复） | 09-02 | 09-02 | 09-02 | 09-02 / 09-14 U-0193、U-0194、U-0195（修复） / 09-14 U-0197（修复） / 09-14 U-0199（修复） |
...
| core | `mirror` | 09-02 | 09-06 U-0045（回退 14 条） / 09-09 U-0149 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-04 U-0009 |
...
| core | `robot/scenario` | 09-02 | 09-06 U-0073（回退 6 条） / 09-09 U-0149 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 |
...
| core | `webroute` | 09-02 | 09-06 U-0075（回退 3 条） / 09-09 U-0149 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 |
| core | `worker` | 09-02 | 09-02 / 09-09 U-0147 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 |
...
| kit | `etcd`（新位置 core/etcd/driver） | 09-02 | 09-06 U-0086（回退 3 条） / 09-09 U-0129（回退 11 条，1 待真机） / 09-09 U-0153（真机） | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 |
...
| kit | `manager` | 09-02 | 09-02 / 09-09 U-0150 / 09-09 U-0152 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 |
| kit | `mods` | 09-02 | 09-02 / 09-09 U-0150 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 |
| kit | `mongo` | 09-02 | 09-05 U-0012 / 09-09 U-0153（真机） | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 |
| kit | `mongo/mongotest`（新位置 core） | 09-02 | 09-06 U-0084（回退 3 条） / 09-09 U-0112（回退 12 条） | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 |
| kit | `nats`（新位置 core/nats/driver） | 09-02 | 09-05 U-0012 / 09-06 U-0079（回退 5 条） / 09-09 U-0135（回退 9 条，全包 18 条清零） / 09-09 U-0153（真机） | 09-02 | 09-02 | 09-06 U-0036 / U-0042 | 09-06 U-0036 | 09-06 脚本扫 | 09-02 |
| kit | `nest` | 09-02 | 09-02 / 09-09 U-0150 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 |
| kit | `nestwal`（新位置 core） | 09-02 / 09-13 U-0186（修复） | 09-06 U-0027 / 09-06 U-0048（回退 40 条） / 09-09 U-0108（回退 14 条） | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-05 U-0013 / 09-13 U-0185（修复） / 09-14 U-0190（修复） |
...
| kit | `remoteentity`（新位置 core） | 09-02 | 09-05 U-0023（真实 Mongo） / 09-06 U-0049（回退 40 条） / 09-06 U-0093（回退 8 条） / 09-09 U-0128（回退 12 条） / 09-13 U-0179（修复） | 09-02 | 09-04 U-0011 / 09-06 U-0025 | 09-02 | 09-02 | 09-02 | 09-05 U-0023 / 09-10 U-0168（修复） / 09-11 U-0173（修复） / 09-13 U-0178（修复） / 09-13 U-0176、U-0177（修复） / 09-13 U-0184（修复） / 09-13 U-0187、U-0188（修复） / 09-13 U-0189（修复） |
| kit | `robot` | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 |
| kit | `room` | 09-02 | 09-02 / 09-06 U-0095（回退 20 条） / 09-09 U-0150 / 09-10 U-0163（修复） | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 / 09-15 U-0207（修复） / 09-15 U-0208（修复） |
...
| service | `account`（新位置 kit/service） | 09-06 脚本扫 | 09-04 U-0005 / 09-06 U-0058（回退 30 条） / 09-06 U-0098（回退 3 条） / 09-09 U-0142（回退 8 条） | 09-09 脚本扫 | 09-09 脚本扫 | 09-06 脚本扫 | 09-09 脚本扫 | 09-06 脚本扫 | 09-05 U-0021 |
| service | `chat` | 09-06 脚本扫 | 09-04 U-0007 / 09-09 U-0150 | 09-09 脚本扫 | 09-09 脚本扫 | 09-06 脚本扫 / 09-09 U-0122（prune 失败计数，修复） | 09-05 U-0022 | 09-06 脚本扫 | 09-09 脚本扫 |
...
| service | `global/activity` | 09-06 脚本扫 | 09-05 U-0020（回退验证） / 09-09 U-0150 | 09-05 U-0020（回调内重置，无问题） | 09-09 脚本扫 | 09-06 脚本扫 / 09-09 U-0120（sweep 失败计数，修复） | 09-09 脚本扫 / 09-09 U-0119（sweep 组来源，修复） | 09-06 脚本扫 | 09-09 脚本扫 / 09-14 U-0191、U-0192（修复） |
| service | `mail`（新位置 kit/service） | 09-06 脚本扫 | 09-04 U-0006 / 09-06 U-0054（回退 40 条） / 09-06 U-0096（回退 3 条） / 09-07 U-0103（回退 16 条） / 09-09 U-0140（回退 7 条，2 冗余） / 09-11 U-0170（修复） / 09-13 U-0182（修复） | 09-09 脚本扫 | 09-09 脚本扫 | 09-06 脚本扫 | 09-09 脚本扫 | 09-06 脚本扫 | 09-09 脚本扫 / 09-09 U-0145（Get / GetMany 同判，修复） / 09-10 U-0165（修复） / 09-11 U-0171（修复） |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| U-0208 | 2026-09-15 | roost-core `room` downstream 替换的生命周期交接(RR-20260915-05) | C8 | 构造时向初始 sink 注册 handleSlowConsumer,SetDownstream 只换指针:新 sink 剔除后 room 订阅不清,旧 sink 回调残留到 Close。修法:同实例直接返回;新 sink 先注册(失败保留旧 sink 与旧回调),再切换 downstream、解除旧注册、接管 unregister;匿名接口抽成 roomSlowConsumerLifecycle | `downstream_handover_promises_test.go`(审查三子例;同实例幂等、已关闭的新 sink 被拒且旧注册保留) | 修前红(`new sink callback finished but stale membership=…` / `old sink still holds 1 room callback after replacement`);修后 room 与 core 全仓含 -race 全绿 | T-102 · `docs/bugfix/RR-20260915-05.md` |
| U-0207 | 2026-09-15 | roost-core `room` 剔除通知与批次结果分别交接(RR-20260915-04) | C8 | 慢连接剔除(删基线、deadSessions、RemoveSession)是不可撤销副作用,但通知只在整体成功出口派发:剩余路由重试再失败时 `return nil, err` 丢掉已累积通知,之后重试跳过 dead 路由再也生成不出来,room 保留失效订阅与名额。修法:错误出口 `return events, err`;AdmitRoomFrames 失败不提交 plans,但两条出口都在释放 room 锁后 dispatchSlowConsumers | `eviction_notice_promises_test.go`(真实 broadcaster→sink 链,末端 transport 两阶段注入;成功对照) | 修前红(`evicted session remains subscribed after retry: … DeadSessions:1 CallbackPending:0 … ActiveSubscribers:2`);修后 room 与 core 全仓含 -race 全绿 | T-101 · `docs/bugfix/RR-20260915-04.md` |
| U-0206 | 2026-09-15 | roost-core `entitysync` + `entity` 持久化水位门槛覆盖全部出口(RR-20260915-03) | C8 | 门槛只在 FlushSubject,且是 check-then-prepare;Subscribe(含 profile 切换)与 Prepare→Distribute 直接准入未落盘状态。修法:`SubjectSyncUpdate.CommitLSN` 在实体锁内随内容一起捕获(与 nest 锁内盖 LSN 同一把锁),协调器按 update 的 LSN 判:Subscribe 推迟则回滚到原订阅并返回 `ErrDurabilityDeferred`,DistributeBatch 任一推迟整批 abort 保持 dirty,FlushSubject 把推迟映射回 nil | `durability_gate_promises_test.go`(审查五叶子;推迟可重试、原订阅保留、状态仍 dirty、水位追上后成功) | 修前红(`non-durable LSN=7 watermark=0 escaped via subscribe: batches=1`);修后 entity / entitysync 与 core 全仓含 -race 全绿 | T-100 · `docs/bugfix/RR-20260915-03.md` |
...
| U-0201 | 2026-09-15 | roost-core `statesync` ForceFull 与 ACK 水位的解耦(RR-20260914-11) | C8 | 两个 ACK 入口推进 ackTick 时无条件清 forceFull:ForceFull 之前发出的帧的 ACK 迟到就取消了恢复,下一帧仍是 delta。修法:删掉 ACK 路径的清除;释放点唯一化为 commitPrepared 里当前 generation 的全量帧提交(本来就有,且 ForceFull 会 generation++) | `recovery_intent_promises_test.go`(四子例 + 全量提交后回到 delta) | 修前红(`ForceFull lost: kind=2 base=1`);修后 -race 全绿,无旧测试依赖 ACK 清标志 | T-95 · `docs/bugfix/RR-20260914-11.md` |
| U-0200 | 2026-09-15 | roost-core `statesync` 基线身份:一个 tick 一个视图(RR-20260914-10) | C8 | `sent` 按 tick 键、ACK 只报 tick,同 tick 重投影覆盖 sent[tick] 后迟到 ACK 绑错基线,后续 delta 零变化而客户端永远少对象。修法:`prepare` 发现该 tick 已提交就复用已发送视图(兴趣变化延到下一 tick);`commitPrepared` 对同 tick 不同视图按 stale 拒绝(并发准备兜底,靠 delta 操作幂等 / 客户端 resync 收敛);`prepare` 返回改为 `prepareResult` 结构体 | `baseline_identity_promises_test.go`(审查两子例 + 并发准备 stale / 冻结复用幂等) | 修前红(`client objects=1 want=2, delta changes=0 base=1`);修后 -race 全绿 | T-94 · `docs/bugfix/RR-20260914-10.md` |
| U-0199 | 2026-09-14 | roost-core `lockstep` SubmitInput 的校验顺序与环下标(用户复审提出,无 RR) | C8 | 身份环按客户端给的 uint32 帧号寻址,而寻址排在窗口检查之前:被 ErrFrameTooEarly 拒绝的垃圾帧号照样分配了 129 槽的环,且 `int(original)%size` 在 int 为 32 位的平台上得到负下标(int32(4e9)%129 = -24)会 panic 并带走房间。修法:折叠与窗口检查前移、身份查找后移(等价性:被记住的 original 恒满足 <= next+window,而 next 只增、window 固定,越窗的 original 不可能有身份),`replaySlotIndex` 在 FrameID 域取模 | `submit_validation_promises_test.go`(拒绝的帧号不得触碰环 + 合法提交后去重仍幂等;下标对任意 uint32 落在环内) | 修前红(`a refused submission indexed the identity ring with the client's frame id before validating it: ring len=129`);修后 lockstep 与 core 全仓含 -race 全绿,GOARCH=386 编译通过。32 位的行为红本机无法执行,已在记录边界写明 | T-93 · `docs/bugfix/U-0199-submit-input-validation-order.md` |
...
| U-0193 | 2026-09-14 | roost-core `lockstep` 输入重传的幂等(RR-20260914-04) | C8 | 迟到输入折成 next 只在目标帧 map 去重,切帧即忘:已入帧 1 的输入重传又进帧 2,首次迟到的重传又进帧 3。修法:每玩家 `accepted[original]=target` 身份表,SubmitInput 先查身份命中即返回原目标帧;所有被接受结果都记;Advance 按 `ReplayHorizon`(64 帧)修剪;乱序未来帧不受影响 | `input_replay_promises_test.go`(按时 / 首次迟到重传;乱序 3→2;显式覆盖占位后重传) | 修前红(`same original input executed in frames 1 and 2`);修后 -race 全绿 | T-87 · `docs/bugfix/RR-20260914-04.md` |
| U-0192 | 2026-09-14 | roost-kit `service/global/activity` 派发的跨轮重新发现(RR-20260914-03) | C8 | sweepGroup 只对本轮 advanced 调派发,活动完成即出窗口:退避到期的重试、notify 收齐完成的、上轮 Create 失败本轮 heal 的都没有入口(Attempts 停在 1 / 0 / 0)。修法:窗口记录加独立 `Delivering` 列表(不占开活动名额),完成退出 Keys 时同 CAS 进入;`DeliveringActivities` 排序 + 每组游标轮转;`RetireDelivered` 先 ensureDispatches 兜底、全部终态才退出 | `dispatch_rediscovery_promises_test.go`(grace / notify / heal 两轮 Attempts=2;ACK 与 exhausted 退出) | 修前红(`two due sweeps: attempts=1 want=2 state=pending due=true`);修后 activity 含 -race 全绿、kit 全量绿 | T-86 · `docs/bugfix/RR-20260914-03.md` |
| U-0191 | 2026-09-14 | roost-kit `service/global/activity` 窗口条目的生命周期(RR-20260914-02) | C8 | OpenActivity 先 admit 后 Create,sweep 把"有条目无记录"一律当死条目删:交错后活动成功打开却永远不被扫,`status=collecting window=[]`。修法:`Window.Opening` 带 AdmittedAt,Create 后 `confirmWindow` 无条件挪进 Keys;sweep 对 Opening 存在则代为确认、缺失超过 `OpeningGrace` 才回收且回收 CAS 只删仍在 Opening 的;容量按 Keys+Opening | `open_window_lifecycle_promises_test.go`(Create 前插一次真实 sweep;Create 后崩溃由 sweep 认领;Create 一直失败宽限后回收) | 修前红(`open succeeded but expired activity stranded: status=collecting window=[]`);修后 activity 含 -race 全绿、kit 全量绿 | T-85 · `docs/bugfix/RR-20260914-02.md` |
| U-0190 | 2026-09-14 | roost-core `nestwal` Sync 屏障的关闭分支(RR-20260914-01,U-0185 引入) | C8 | `closed`(Close 已发起、拒绝新准入)被当成 `doneCh`(writer 已排空并 sync):writer 收批未写时发起 Close,Sync 立即返回 nil 而 ticket 未完成。修法:删掉 closed 早返回,关闭进行中照常送屏障、按 ctx 等 doneCh,doneCh 关闭后返回 terminal(最终 sync 失败不读成成功);完全关闭后仍幂等 nil | `sync_closing_promises_test.go`(writer 钉在收批与写之间,open/closing 两子用例;Close 完成后对照) | 修前红(`closing=true err=<nil> admitted=1 appended=0 durable=0 ticket=1`);修后 nestwal 含 -race 全绿 | T-84 · `docs/bugfix/RR-20260914-01.md` |
| U-0189 | 2026-09-13 | roost-core `remoteentity` 共享模式切换的不确定结果(RR-20260913-12) | C8 | Enter/LeaveShared 对任何存储错误恢复旧模式:Lua 已把权威切成 shared、回复丢失后本地回到 local_owned,独占快捷准入放行,与权威的共享模式不一致。修法:U-0188 的骨架参数化为 `settleIndeterminateOwnership`(applied 判据按模式目标),三个入口共用;Sharing 经 Fenced 进 Recovering 冻结。第十轮:RR-20260913-13(Leave 恢复后普通写重试卡在 `shared -> local_owned` 非法迁移)由同一修复覆盖,Leave 测试补连续三次准入断言 | `ownership_mode_indeterminate_promises_test.go`(Enter 丢回复 / Enter 后权威黑屏 / Leave 丢回复 / 发送前失败对照) | 修前红(`authority_shared=true state=local_owned admission=<nil>`);修后 remoteentity 含 -race 全绿 | T-83 · `docs/bugfix/RR-20260913-12.md` |
| U-0188 | 2026-09-13 | roost-core `remoteentity` 所有权转移的不确定结果(RR-20260913-09) | C8 | `TransferExpected` 的任何错误都恢复 local_owned,热 marker 继续被信任;Lua 已改 owner、回复丢失时旧 owner 仍被放行。修法:失效 marker,用独立有界 ctx 重查权威——未变→恢复,已转移→按成功 fence,别人→fence,查不到→live 进 `Recovering` 冻结;准入与下一次转移在权威读成功后解冻 | `ownership_transfer_indeterminate_promises_test.go`(执行后丢回复 / 执行后权威黑屏 / 发送前失败对照) | 修前红(`unknown outcome restored old owner: live=local_owned`);修后 remoteentity 含 -race 全绿 | T-82 · `docs/bugfix/RR-20260913-09.md` |
| U-0187 | 2026-09-13 | roost-core `entity` + `remoteentity` 快照删除的版本屏障(RR-20260913-01) | C8 | 复制侧 `cache.Delete(key)` 不看 `env.Version` 也不留水位,迟到的 delete v2 清掉 v3、先到的 delete v2 之后 full v1 复活。修法:`DeleteAtVersion` 与 `Publish` 共用分片锁,比 L1 新的删除不动,否则删并留 `TombstoneTTL`(默认=缓存 TTL)内的墓碑;Publish 丢弃 <= 墓碑版本的写、更新的清墓碑;复制接收与提交后失效都按版本删。09-13 复核补修:`StoreConfig.Superseded` 把墓碑接进 L1 分片锁下的统一准入(回填不再越过),回填被拒返回 L1 现值或 miss;L2 新增 `DeleteAtVersion` 脚本,冷 L1 的旧删除不再清掉较新的 L2(`snapshot_delete_l2_promises_test.go`、`snapshot_l2_delete_promises_test.go`) | `snapshot_delete_order_promises_test.go`(真实 ReplicaStore 重排投递)、`snapshot_delete_version_promises_test.go`(缓存层含墓碑到期边界) | 修前红(`old delete removed v3` / `deleted snapshot resurrected`);修后 entity / remoteentity 含 -race 全绿 | T-81 · `docs/bugfix/RR-20260913-01.md` |
| U-0186 | 2026-09-13 | roost-core `nestwal` Committer 停机等待的可取消性(RR-20260912-01) | C1 | `Flush` / `replayPass` 用 `sync.Mutex` 等 replay 所有权,后台 pass 卡在 applier 时带截止时间的 `Shutdown` 无界等待(applier 听的是 committer 自己的 ctx)。修法:`flushMu` / `replayMu` 换成一格信号量 `acquireSlot(ctx, sem)`,等待随 ctx 取消;Shutdown 形状不变 | `shutdown_deadline_promises_test.go`(后台 replay 忙时 Shutdown 20ms 到期;两个并发 Flush) | 修前红(`Shutdown stayed blocked behind background replay after its context expired`);修后 nestwal 含 -race 全绿 | T-80 · `docs/bugfix/RR-20260912-01.md` |
| U-0185 | 2026-09-13 | roost-core `nestwal` WAL.Sync 对已准入记录的覆盖(RR-20260912-02) | C8 | `Sync` 只 fsync 当前文件,记录还在 appendCh / BatchDelay 收集窗口时返回 nil 而 ticket 未完成;注释"Append 已等物理写入"没跟上 Enqueue 的异步路径。修法:Sync 先往 appendCh 放 `barrier` 请求(FIFO 保证前面的都已写入),collectBatch 见屏障即收批,processBatch 写完记录再答复屏障并带终止错误,答后再 fsync;等待遵守 ctx,Close 后空满足 | `sync_barrier_promises_test.go`(BatchDelay=1h 下 Enqueue 后 Sync 必须覆盖 ticket;Close 后不阻塞) | 修前红(`Sync returned nil before admitted ticket resolved: admitted=1 appended=0 durable_lsn=0 ticket_lsn=1`);修后 nestwal 含 -race 全绿 | T-79 · `docs/bugfix/RR-20260912-02.md` |
| U-0184 | 2026-09-13 | roost-core `remoteentity` 兴趣订阅的代际(RR-20260913-02) | C8 | 接收端 release 按 key/SID 无条件删,迟到的旧 release 取消新 renewal;ExpiresAt 不能当版本(合法 release 早于 lease 到期)。修法:`RemoteSnapshotInterest.Generation` 只增(计数器从 UnixNano 播种,重启复用 SID 不倒退),注册表记 `{expiresAt, generation}`,renew 忽略落后代际,release 只删不落后的。09-13 复核补修:进程级代际高水位,播种取 max(now, 已发出+1),同一时钟刻度创建的两个 Manager 也严格递增(`interest_generation_seed_promises_test.go`,冻结时钟) | `interest_generation_promises_test.go`(注册表层交错 + Manager 层递增与重启) | 修前红(`an older release canceled the newer renewal`);修后 -race 全绿 | T-78 · `docs/bugfix/RR-20260913-02.md` |
| U-0183 | 2026-09-13 | roost-core `nest` AfterCommit 的异常控制流(RR-20260911-06) | C5 | `Commit` 无逐项隔离,一个业务回调 panic 跳过后续回调(含 TransactionReleased)与回复;饱和内联回退无 SafeFunc 边界可致进程退出。修法:`Commit() error` 逐项 recover 并以 `ErrAfterCommitFailed` 报告、继续执行后续回调;异步完成按该错误回复并计 `completion_failed`;饱和回退包进 `goroutine.SafeFunc` | `commit_callback_panic_promises_test.go`(中间回调 panic,前后回调都跑、返回错误;二次 Commit 幂等) | 修前签名无返回值不编译、panic 穿出;修后 nest 含 -race 全绿 | T-77 · `docs/bugfix/RR-20260911-06.md` |
| U-0182 | 2026-09-13 | roost-kit `service/mail` Update 回调的所有权(RR-20260911-05,P3) | C2 | 回调拿到的 Mailbox 浅拷贝共享两张 map,先改后拒,存储的 map 已变而 Unread/Version 未变。修法:五个 Update 回调首行 `current = current.clone()`,与 match 一致 | `atomic_refusal_promises_test.go`(推到 ClaimHistoryFull 后再拒一次,断言条目、墓碑、版本、Unread 一致) | 修前红(`Unread field 199 disagrees with 200 actual unread entries`);修后 mail 含 -race 全绿 | T-76 · `docs/bugfix/RR-20260911-05.md` |
| U-0181 | 2026-09-13 | roost-core `cache` + `entity` L2 回填的同版本校验(RR-20260913-06) | C8 | L2 命中直接 `setLocal`,与同版本发布交错时把 L1 改回旧内容;Get-then-Set 不原子。修法:`StoreConfig.Conflict` 钩子在 `AtomicLocalStore` 分片锁下与 `Stale` 一并判,冲突返回新 `ErrConflictingWrite`;回填遇冲突不覆盖、回读 L1 返回;entity 配置同版本内容比较 | `snapshot_l2_conflict_promises_test.go` 的 backfill 用例(L2 Get 带屏障的确定性交错) | 修前红(`L1="A"`);修后 cache / entity 含 -race 全绿 | T-75 · `docs/bugfix/RR-20260913-06.md` |
| U-0180 | 2026-09-13 | roost-core `entity` 发布时 L2 冲突的可见性(RR-20260913-05) | C8 | `IgnoreRemoteError` 把 L2 的版本冲突当可用性故障吞掉,Publish 返回 nil,L1=B/L2=A。修法:L1 未命中时先有界地问 L2 一次,同版本不同内容即 `ErrRemoteVersionConflict` 不落写;L2 读失败仍按故障降级;同版本比较抽成共用函数。09-13 复核补修:`ReadThroughOptions.FatalRemoteError` 分类,预检查之后 L2.Set 的版本冲突不再被 IgnoreRemoteError 吞掉(`TestPublishConflictAfterPreflight`) | `snapshot_l2_conflict_promises_test.go` 的 publish 用例(含 L2 故障仍降级的对照) | 修前红(`= <nil>, want ErrRemoteVersionConflict`);修后 entity 含 -race 全绿 | T-74 · `docs/bugfix/RR-20260913-05.md` |
| U-0179 | 2026-09-13 | roost-core `remoteentity` 接收侧 payload 身份绑定(RR-20260913-03) | C2 | 通用 Replicator 校验外层 SyncMsg 与 Envelope,但 Remote 第三层的 `wire.Key` / `Update.Key` / `Update.StateVersion` 从未与它们交叉校验:只改 payload 里的 Scope,消息照样通过并写进另一个 scope 的缓存。修法:接收入口 `validateSnapshotWireIdentity` 要求 key 合法、外层 key 等于按完整 key 算的 replica key、payload key 等于 wire key、外层 version 等于 payload 版本,不符即拒且不落写 | `snapshot_payload_identity_promises_test.go`(四种畸形 + 断言外来 scope 前后不变) | 修前红;修后 remoteentity 含 -race 全绿 | T-73 · `docs/bugfix/RR-20260913-03.md` |
| U-0178 | 2026-09-13 | roost-core `remoteentity` marker lease 的线格式(RR-20260913-11,P3) | C8 | 三个脚本 `.. ((tonumber(x) or 0)+1)` 拼的是 Lua 数值,Lua 5.1 用 `%.14g` 渲染,10^14 写成 `1e+14`,Go 解析失败而记录已经落盘。修法:脚本自带 `incdec` 逐位十进制加一,超过 uint64 返回 nil 由调用处拒绝,写之前校验可表示范围 | `marker_epoch_format_promises_test.go`(三个大 epoch,断言加一正确且能读回) | 替身先改忠实(用 `%.14g` 模拟)才出现红:`invalid marker lease "shared:1001:1e+14:1"`;修后 -race 全绿 | T-72 · `docs/bugfix/RR-20260913-11.md` |
| U-0177 | 2026-09-13 | roost-core `remoteentity` L2 版本比较的数值域(RR-20260913-10,P3) | C8 | 脚本用 `tonumber` 比较 marker / route / version,而 Lua 数值是 float64:超过 2^53 相邻 uint64 塌成同一个值,旧版本被接受、版本回退,或更新版本被误判同版本冲突。修法:按十进制字符串精确比较(去前导零 → 比长度 → 比字典序),存储逐字写 ARGV,只有 TTL 仍走 tonumber | `snapshot_l2_cas_promises_test.go` 的 `TestL2ComparesVersionsExactlyBeyondFloatPrecision` | 替身原先用 ParseUint 比脚本更"正确"因而藏住缺陷,改成 ParseFloat 后变红;修后 -race 全绿 | T-71 · `docs/bugfix/RR-20260913-10.md` |
| U-0176 | 2026-09-13 | roost-core `remoteentity` L2 同版本冲突比较(RR-20260913-07) | C8 | CAS 只比 checksum,而 checksum 只覆盖 payload 字节:同版本同字节换 schema 就被接受,同一份字节的解释方式被改掉,而本地缓存对同样输入是拒绝的。修法:脚本读写 schema / codec 两个字段并纳入同版本比较,替身镜像 | `snapshot_l2_cas_promises_test.go` 的 `TestL2RejectsSameVersionWithADifferentSchemaOrCodec` | 修前红(schema / codec 两例均返回 nil);修后 -race 全绿 | T-70 · `docs/bugfix/RR-20260913-07.md` |
| U-0175 | 2026-09-13 | roost-core `entity` 快照读取准入与绝对有效期(RR-20260913-08) | C8 | 信封有 `ExpiresAt` 与 `Expired()`,但缓存只用固定容器 TTL,`Get` 从不看它:ExpiresAt 在过去、TTL 还剩一分钟时仍然命中,返回一份自己声明已过期的快照。修法:`Get` 命中后判一次 Expired,过期即降级为未命中 —— Cached 答没有,Monotonic 按契约回权威。09-13 复核补修:LoadAuthoritative 的权威原值与 Publish 后的 L1 值各判一次 Expired,同版本相同内容但更晚 ExpiresAt 允许前移(`snapshot_expiry_authoritative_promises_test.go`) | `snapshot_expiry_promises_test.go`(过期不命中、Monotonic 回权威且只问一次、无 ExpiresAt 的照常命中) | 修前红(`served a snapshot that declares itself expired`);修后 entity 含 -race 全绿 | T-69 · `docs/bugfix/RR-20260913-08.md` |
| U-0174 | 2026-09-13 | roost-core `entity` 快照合并加载的等待名额(RR-20260913-04) | C2 | `loadMonotonic` 跟随者取消后不减 `waiters`,上限变成累计入场次数。与 `cache.ReadThroughStore` 的 U-0155 同一个错误,但 entity 这层自建了第二份合并逻辑。修法:取消路径在 `loadMu` 下减回,且仅当 `c.loads[callKey]` 仍是本 call | `snapshot_load_waiters_promises_test.go`(含真满额仍拒绝、归还后新跟随者可进) | 修前红(`load waiters = 1, want 0`);修后 entity 含 -race 全绿 | T-68 · `docs/bugfix/RR-20260913-04.md` |
...
| U-0150 | 2026-09-09 | roost-kit 十二个包 nil / 参数守卫收尾（directory / nest / ops / mods / rank / manager / chat / global / activity / configdata / room / examples/split） | C2（批次） | 本地重采样清单。Mod Provide 的能力查找链式同文本，空注册表只钉第一条、断言核对被点名的能力；`&app.Registry{}` 零值可用于"缺能力"（Lookup 读 nil map 安全）但不能 Register。留待：rank 211 / 224、split 78、manager 131；nats Mod 需真连接 | 十二个包各一条 `*_promises_test.go` | 97 处回退 84 红、8 冗余、4 留待、1 真机 | — |
| U-0149 | 2026-09-09 | roost-core 十二个小包 nil / 参数守卫收尾（ownerroute / hotcode / migration / versionstore / mirror / spatial / robot/scenario / log / configdata / httpclient / nats / webroute） | C2（批次） | 本地重采样清单，全部入口守卫。configdata `resolveShadowing` 的两条镜像检查各需一例；`hotcode/plugin.go:46` 需真插件；`versionstore` 234 为读 / CAS 之间的竞态防御；spatial 212 / 223 双份。core 至此只剩：真机 4 条、不可测 1 条、防御 / 冗余 / 不可达若干 | 十二个包各一条 `*_promises_test.go` | 107 处回退 103 红、1 不可测、1 防御、2 双份 | — |
| U-0148 | 2026-09-09 | roost-core 七个包 nil / 参数守卫收尾（robot/loadtest / ai / dataengine / mongo/driver / entity / saga / skill/skillsync） | C2（批次） | 本地重采样清单。skillsync 的三条准入状态守卫只在另一次 Apply 未提交时可观察，直接注入内部状态；saga 异版本信封要装合法命令才独立于 `Command.Validate`；mongo/driver 三条需真实 Mongo（并入 §0.1 项 1 真机清单） | 七个包各一条 `*_promises_test.go` | 62 处回退 55 红、3 真机、1 防御（saga 124）、3 冗余（ai 312 / dataengine 91 / entity 135） | — |
| U-0147 | 2026-09-09 | roost-core 九个小包 nil / 参数守卫收尾（failurelog / robot / syncbus / servicerpc / lifecycle / admin / etcd / worker / goroutine） | C2（批次） | 本地重采样清单；全部是入口守卫。`KeyAffinityPicker` 空表守卫只在 Key 返回键时才独立（否则回落轮询选择器同一守卫），失效后是 `% 0`；worker 的队列容量向上取整到 ≥16，"填满"要循环到被拒；处理器里向带缓冲通道发进度信号会让 Stop 排空时死锁 | 九个包各一条 `*_promises_test.go` | 40 处回退 37 红、2 冗余（servicerpc 189、etcd 151）、1 不可达（worker 140） | — |
...
| U-0140 | 2026-09-09 | roost-kit `service/mail` 入口 id 校验 / Redis 存储构造 | C2 | nightly 9/20：全部是入口参数守卫；`NewRedisStores` 的客户端 / 前缀检查与 `NewRedisEnvelopes` 同文本互掩（冗余），TTL 检查只此一份 | `entry_guards_promises_test.go` 两条 | 9 处回退 7 红、2 冗余 | — |
| U-0139 | 2026-09-09 | roost-core `statesync` 帧编解码计数 / 大小上限 | C2 | nightly 7/20：`codec.go:17` 失效后 65536 个对象会编成对象数为 0 的"空帧"且无错误；解码侧三处头部预检失效后答案从"超限"变成"截断"（用截断的伪造头部区分）；`codec.go:28` 是组件级大小检查，需要"对象头放得下、加组件越界"的帧；`codec.go:44` 不可达（TypeID 唯一上限 65535） | `codec_limits_promises_test.go` 两条 | 7 处回退 6 红、1 不可达（28 手工回退验证） | — |
| U-0138 | 2026-09-09 | roost-core `cache` 分层 / 读穿透的失败与未命中传播、Redis 键校验、ref-hmap 旧版本 | C2 | nightly 8/20：`layered.go:51` 与 `read_through.go:148` 失效后会把零值回填进 L1 / 写进 L2 并当命中返回，此前无测试；`read_through.go:180`（Set 的严格模式）U-0076 只测了 Get 路径 | `guards_promises_test.go` 四条 | 8 处回退全红；采样 20 条 0 无覆盖 | — |
...
| U-0069 | 2026-09-06 | roost-core `migration` 路径规划（B-22） | C2 | 20/20 无覆盖；降级与跨越目标是"改版本号不跑代码"级别的守卫 | `promises_test.go` 两条 | 五处守卫回退各红 | — |
| U-0068 | 2026-09-06 | roost-core `security` 会话令牌（B-22） | C2 | nightly `security` 5/5；伪造（异密钥、签后改 payload）与畸形 payload 规则无测试；payload 的玩家 id 规则被"期望玩家不符"掩盖——需 `expectPlayerID=0` 才测得到 | `session_token_promises_test.go` 一条（15 变异） | 六处守卫回退各红 | — |
...
**插入特性（2026-09-07，非收敛单元）**：① core `security.RateLimiter` 桶算术改用 `golang.org/x/time/rate`（连续补充；API 不变；按 key 分桶 / MaxKeys / 空闲驱逐保留），新测试在旧实现上变红后才合入 → core v1.13.0；② codegen cfggen 导出分组 `groups.names` / `groups.target` / 条目与字段 `group` / `-groups`，与 Luban group 同语义，旧 meta 产物不变 → codegen v1.14.0，清单对齐 core v1.13.0。
...
### classscan 记录（2026-09-09，117 个"未审"格的首轮脚本扫）

工具：`scripts/gapmap/classscan.py`（三仓同一份拷贝）。它给 C2 之外的类各一条可重复的启发式，**只列候选、不下结论**；格子从"未审"改为"脚本扫"的含义与 09-06 的三类扫描相同——看过一遍、无真洞或已记观察，不等于回退验证。
