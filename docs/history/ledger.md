...
> M-01 entity kind 注册表无锁化、M-02 category 离开 EntityID、M-03 声明式锁序(重构,不占 U 编号)见 [bugfix/](../bugfix/README.md);M-01 那篇记录了 category 重设计的四步方案,目前前三步的框架侧已实施,删除旧符号与生成器接管尚未做。
