...
| core | `cache` | 09-02 | 09-06 U-0076（回退 2 条） | 09-02 | 09-02 | 09-02 | 09-02 | 09-02 | 09-06 U-0076
...
| B-24 | 五仓 nightly gap map 首日（2026-09-07，max=20）选单：core `entity` 19/20、kit `actionflow` 17/20（重入 `ErrReentrantMutation`）、kit `dataengine` 15/20（仓库迁移 / 解码 id 校验）、core `cache` 15/20（ref_hmap 补丁路径）、service `mail` 16/20（多为请求参数守卫，低优先） | C2 | nightly 报告 | entity → U-0099、actionflow → U-0100、dataengine → U-0101 已完成；其余按序推进 |
