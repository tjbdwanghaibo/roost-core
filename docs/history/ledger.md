...
| U-0074 | 2026-09-06 | roost-core `syncstream` 文件日志完整性 | C2 | nightly 4/5：检查点代数不符、WAL 缺失、WAL 行损坏、关闭后写入——回放错历史会让客户端拿到无法对齐的 resync | `file_journal_promises_test.go` 两条 | 四处守卫回退各红 | — |
