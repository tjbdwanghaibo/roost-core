...
//
// Assembly half of the Coordinator transport: what a process needs to OWN this
...
// the wire types, handler table and BusClient in coordinator_rpc_gen.go depend
