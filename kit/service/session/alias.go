...
//
//go:generate go run github.com/tjbdwanghaibo/roost-core/codegen/cmd/servicerpc -dir github.com/tjbdwanghaibo/roost-core/service/session -emit assembly -out .
